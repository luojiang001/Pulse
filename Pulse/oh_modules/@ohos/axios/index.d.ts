...
export interface AxiosRequestConfig<D = any> {
  ...
  dnsOverHttps?: string;
  dnsServers?: string[];
  certificatePinning?: http.CertificatePinning | http.CertificatePinning[];
  addressFamily?: http.AddressFamily | string;
  tlsOptions?: http.TlsOptions;
  serverAuthentication?: http.ServerAuthentication;
  sslType?: 'TLCP'|'TLS';
